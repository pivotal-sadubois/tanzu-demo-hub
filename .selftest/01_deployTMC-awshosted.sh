#!/bin/bash
# ============================================================================================
# File: ........: 01_deployTMC-awshosted.sh
# Language .....: bash
...
selfTestInit "Tanzu Demo Hub - Deploy TKG Cluster with Tanzu Mission Control (aws-hosted)" 10
selfTestStep "./deployTMC -d tmc-aws-awshosted.cfg -c tkg-tanzu-demo-hub.cfg"
selfTestStep "kubectl config get-clusters"
