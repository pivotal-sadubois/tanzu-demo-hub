...
if [ -d ${TANZU_DEMO_HUB}/certificates/${TDH_TKGMC_ENVNAME}.${AWS_HOSTED_DNS_DOMAIN} ]; then
  TLS_CERTIFICATE=${TANZU_DEMO_HUB}/certificates/${TDH_TKGMC_ENVNAME}.${AWS_HOSTED_DNS_DOMAIN}/fullchain.pem
  TLS_PRIVATE_KEY=${TANZU_DEMO_HUB}/certificates/${TDH_TKGMC_ENVNAME}.${AWS_HOSTED_DNS_DOMAIN}/privkey.pem
else
  TLS_CERTIFICATE=${TANZU_DEMO_HUB}/certificates/fullchain.pem
  TLS_PRIVATE_KEY=${TANZU_DEMO_HUB}/certificates/privkey.pem
fi
