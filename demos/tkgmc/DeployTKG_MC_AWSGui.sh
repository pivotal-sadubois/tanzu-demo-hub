#!/bin/bash
# ============================================================================================
# File: ........: DeployTKG_MC_AWSGui.sh
# Language .....: bash
# Author .......: Sacha Dubois, Pivotal
# --------------------------------------------------------------------------------------------
# Description ..: Deploy the TKG Management Cluster on AWS
# ============================================================================================
...
echo '                                                                                      '                                           
echo '          ----------------------------------------------------------------------------'
echo '                      Deploy TKG Management Cluster on Microsoft AWS                  '
...
export TDH_DEPLOYMENT_ENV_NAME="AWS"
export TKG_CONFIG=/Users/sdubois/workspace/tanzu-demo-hub/config/tkgmc-aws-eu-central-1.yaml
checkCloudCLI
checkCloudAccess
checkKeyPairs
