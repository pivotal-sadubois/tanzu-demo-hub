#!/bin/bash
# ============================================================================================
# File: ........: tap-app-weatherforecast-steeltoe.sh
# Language .....: bash
...
ytt -f /tmp/weatherforecast-steeltoe/config/workload_orig.yaml -f files/overlay.yaml \
  --data-value-yaml git.url="https://$GIT_REPO_SERVER/$GIT_REPO_USER/${DEMO_APP_ID}.git" \
  --data-value-yaml git.branch=baster

echo "ytt -f $GIT_REPO_DIR/config/workload_orig.yaml -f files/overlay.yaml"
